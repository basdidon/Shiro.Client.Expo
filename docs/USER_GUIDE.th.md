...
เมื่อเข้าสู่ระบบแล้ว คุณจะเข้าสู่แถบแท็บหลักซึ่งมี 5 แท็บ ได้แก่ **หน้าแรก** (Home), **หมวดหมู่** (Categories), **รายการสินค้า** (Products), **แสกนสินค้า** (Scan) และ **โปรไฟล์** (Profile)
...
- **หมวดหมู่ (แท็บ Categories)**: แสดงกริดไอคอนหมวดหมู่ แตะที่หมวดหมู่ใดก็ได้เพื่อดูสินค้าในหมวดนั้น
...
เข้าถึงได้ผ่าน **โปรไฟล์ → คำสั่งซื้อของฉัน** (My orders)
...
- แต่ละรายการแสดงจำนวนเงิน วิธีชำระเงิน (เงินสด/Cash หรือ โอนเงิน/Bank transfer) และลิงก์กลับไปยังคำสั่งซื้อที่เกี่ยวข้อง รายการที่ถูกยกเลิกจะแสดงเป็นสีจาง
...
- **ทั่วไป (General)** — คำสั่งซื้อของฉัน, ที่อยู่ที่บันทึกไว้, การชำระเงินของฉัน/ทั้งหมด
- **ฐานข้อมูล (Database)** _(เฉพาะผู้จัดการสินค้า)_ — จัดการหมวดหมู่, เพิ่มสินค้า
- **การจัดการ (Management)** _(ผู้จัดการคำสั่งซื้อ/พนักงาน/ผู้ดูแลระบบ)_ — คำสั่งซื้อทั้งหมด, ผู้ใช้งาน _(เฉพาะเจ้าของร้าน/ผู้ดูแลระบบสูงสุด)_
...
แอปจะปรับสิ่งที่คุณเห็นตามบทบาทที่ได้รับมอบหมาย:
